...
if len(files)==0:
    ...
    for i in files:
        ...
        df1['Error_min'] = df['Error-Mech']*60
        df1['Error_min'] -= df1['Error_min'].mean()
        ...
        fig.add_trace(go.Scatter(
            x=df1[graph1_xoption], 
            y=df1[graph1_yoption],
            name=graph1_yoption,
            legendgroup = '1')
            , row=1, col=1)
        ...
        fig.add_trace(go.Scatter(
            x=df1[graph1_xoption], 
            y=df1[graph1_y2option],
            name=graph1_y2option,
            legendgroup = '1')
            , row=1, col=1)
